...
p rowsum_greater(ary2D,30)


trenner("c4 key_with_max_value")
srand(999999999999999)
size=10
h = {}
until h.size() == size
...
puts "h:#{h}"
puts "key_with_max_value(h): #{key_with_max_value(h)}"

trenner("c5 sort_down_by_value")

puts "h:#{h}"

puts "#{sort_down_by_value(h)}"
