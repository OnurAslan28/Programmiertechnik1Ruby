...
def if_anweisung(temperatur, windstaerke, niederschlag)
...
def if_kaskade(temperatur, windstaerke, niederschlag)
...
def case_bedingung(temperatur, windstaerke, niederschlag)
...
puts ("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZbcdef" <=> "abcdefg")
...
# 1.Testfall
str1 = "    Intelligenz    ;   i s t   ; für   ;     dumme   ;  M enschen    "
str1 = str1.split(';')
p str1
